...
public class Driver{
    ...
    public static void main (String[] args){
        ...
        System.out.println ("Unfortunately, the only way to escape is through the Super-Duper-Rico Train, which for some reason costs 150 gold coins. To make money, you need to work. The Super-Duper-Rico station opens every day at midnight, but at Nightmare Farm, something happens every day at 11 PM...");
